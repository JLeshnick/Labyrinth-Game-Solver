...
- Added **3D Board Tray Platform**: Grid board tilts inside a real 3D play tray with border boundaries and beveled drop shadows.
...
### Changed
- Unified all tiles to render as a consistent warm stone gray clay block (pawn starts retain colors for game logic).
